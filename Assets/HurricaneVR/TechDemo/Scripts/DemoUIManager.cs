...
namespace HurricaneVR.TechDemo.Scripts
{
    public class DemoUIManager : MonoBehaviour
    {
        ...
        public GameObject characterAUI;
        public GameObject characterBUI;
        public GameObject characterCUI;
        public GameObject characterDUI;
        ...
        public void OnCharacterAClicked()
        {
            characterUI.SetActive(false);
            characterAUI.SetActive(true);

        }
        public void OnCharacterBClicked()
        {
            characterUI.SetActive(false);
            characterBUI.SetActive(true);

        }
        public void OnCharacterCClicked()
        {
            characterUI.SetActive(false);
            characterCUI.SetActive(true);

        }
        public void OnCharacterDClicked()
        {
            characterUI.SetActive(false);
            characterDUI.SetActive(true);

        }
        public void OnChangeCharacterClicked() 
        { 
            characterAUI.SetActive(false);
            characterUI.SetActive(true);
        }
        public void OnChangeCharacterBClicked()
        {
            characterBUI.SetActive(false);
            characterUI.SetActive(true);
        }
        public void OnChangeCharacterCClicked()
        {
            characterCUI.SetActive(false);
            characterUI.SetActive(true);
        }
        public void OnChangeCharacterDClicked()
        {
            characterDUI.SetActive(false);
            characterUI.SetActive(true);
        }
